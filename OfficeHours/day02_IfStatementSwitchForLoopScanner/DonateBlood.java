...
public class DonateBlood {
    ...
    public static void main(String[] args) {
      ...
      (DonateBlood)
       ...
       If age greater than or equal to 18 and weight greater than 50 kg give a message
       EXPECTED  :  "You are eligible to donate blood"

       If age greater than or equal to 18 and weight smaller or equal than 50 kg give a message
