...
public class MapPractice4 {
    ...
    public static void main(String[] args) {
        ...
        // Pair: IDs and names of students
        ...
        /* {1=[Duygu, Magda, Farangez, Edison, Kerem, Farangis], 2=[Margie, Vesele, Iryn, Nilufar, Aziza, Nurcan,
            Raika, Igor, Elif, Sana, Azamat], 5=[Nazar, Veronika, Mikael, Layla, Badmaa, Zaeir, Anna, Tamara, Eugene],
            9=[Alex, Ali, Andriy, Cassandra, Sevgul, Olha, Tito, Ozan, Serkan, Furkan, Madina, Muharrem], 24=[Maria,
            Kristina, Amin, George, Layan, Amin, Yulia, George, Ayanle, Maxim, Nermin, Doughlas]}
